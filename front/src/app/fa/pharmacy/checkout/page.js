                ...
                <Row gutter={[24, 24]} style={{ marginTop: '24px' }}>
                    <Col xs={24} lg={16}>
                        <Card title="📋 خلاصه سفارش" style={{ borderRadius: '16px' }}>
                            ...
                            {/* ✅ انتخاب داروخانه */}
                            <div style={{ marginBottom: '16px' }}>
                                <Text strong>انتخاب داروخانه:</Text>
                                <Select
                                ...
                                {selectedPharmacy && (
                                    <div style={{ marginTop: '8px', padding: '12px', background: '#f0f7ff', borderRadius: '8px' }}>
                                        <div>
                            ...
                            {!selectedPharmacy && (
                                <div style={{ marginTop: '8px' }}>
                                    <Text type="danger" style={{ fontSize: '12px' }}>
                                        ⚠️ لطفاً یک داروخانه را انتخاب کنید
                                    </Text>
                                </div>
                            )}
