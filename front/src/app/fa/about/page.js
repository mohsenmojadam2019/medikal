      ...
      <main style={{ minHeight: 'calc(100vh - 200px)' }}>
        <div style={{ maxWidth: '1200px', margin: '40px auto', padding: '0 20px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <Title level={2}>🏥 درباره کلینیک‌یار</Title>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} lg={12}>
              <Card style={{ borderRadius: '16px', height: '100%' }}>
                ...
                <Paragraph>
                  کلینیک‌یار با هدف ساده‌سازی فرآیند مدیریت سلامت و ارتباط بین پزشکان و بیماران ایجاد شده است.
                  ما معتقدیم که دسترسی آسان به خدمات پزشکی حق همه افراد است.
                </Paragraph>
                <Paragraph>
                  با استفاده از پلتفرم کلینیک‌یار، بیماران می‌توانند به راحتی نوبت خود را رزرو کنند،
                  با پزشکان خود در ارتباط باشند و پرونده الکترونیک خود را مدیریت کنند.
                </Paragraph>
                <Divider />
                <Title level={5}>چشم‌انداز</Title>
                <Paragraph>
                  تبدیل کلینیک‌یار به مرجع اصلی خدمات سلامت دیجیتال و بهبود کیفیت زندگی مردم از طریق فناوری.
                </Paragraph>
