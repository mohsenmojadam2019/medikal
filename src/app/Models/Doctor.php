...
class Doctor extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'is_verified',
        'is_active',
        'offers_in_person_consultation', 'offers_text_consultation', 'offers_video_consultation', 'offers_home_visit',
        'in_person_fee', 'text_consultation_fee', 'video_consultation_fee', 'home_visit_fee',
        'rating',
        'total_reviews',
        'metadata',
    ];
    ...
    protected $casts = [
        ...
        'is_verified' => 'boolean',
        'is_active' => 'boolean',
        'offers_in_person_consultation' => 'boolean', 'offers_text_consultation' => 'boolean', 'offers_video_consultation' => 'boolean', 'offers_home_visit' => 'boolean',
        'in_person_fee' => 'decimal:2', 'text_consultation_fee' => 'decimal:2', 'video_consultation_fee' => 'decimal:2', 'home_visit_fee' => 'decimal:2',
