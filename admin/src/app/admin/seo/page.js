...
export default function SeoPage() {
  ...
  const handleReset = () => {
    setSearchText('');
    setFilters({});
    fetchSeo({ page: 1, search: '', ...filters });
  };
      ...
      render: (type, record) => (
        <div>
          <div style={{ fontWeight: 600 }}>
            {record.seoable?.name || record.seoable?.title || '—'}
          </div>
        ...
        <Row gutter={[16, 16]} align="middle">
          ...
          <Col xs={24} sm={12} md={8} lg={6}>
            ...
            >
              ...
              <Select.Option value="App\Models\BlogPost">مقاله</Select.Option>
        ...
        {selectedSeo && (
          <div>
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontWeight: 600 }}>
                {selectedSeo.seoable?.name || selectedSeo.seoable?.title || '—'}
              </div>
            </div>
