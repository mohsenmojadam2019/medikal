// src/app/admin/reminders/page.js
...
export default function RemindersPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'patient',
      key: 'patient',
      render: (patient) => patient?.full_name || patient?.name || '—',
    },
    {
      title: t('message', 'متن'),
      dataIndex: 'message',
    ...
    {
      title: t('scheduled_at', 'زمان ارسال'),
      dataIndex: 'scheduled_at',
      key: 'scheduled_at',
      render: (date) => formatJalaliDate(date),
    },
    {
      title: t('sent_at', 'زمان ارسال شده'),
      dataIndex: 'sent_at',
      key: 'sent_at',
  ...
  // اگر reminders آرایه نیست
  if (!Array.isArray(reminders)) {
    console.error('⚠️ Reminders is not an array:', reminders);
    return (
      ...
      <div>
        ...
        >
          <Row gutter={[16, 16]} align="middle">
            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              <Space>
                <Button type="primary" icon={<SearchOutlined />} onClick={() => fetchReminders({ page: 1 })}>
                  {t('search', 'جستجو')}
                </Button>
