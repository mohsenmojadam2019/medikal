...
export default function RatingsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'score',
      render: (score) => (
          <Rate disabled defaultValue={score} allowHalf count={5} style={{ fontSize: 16 }} />
      ),
    },
    {
      title: t('comment', 'نظر'),
  ...
  // اگر ratings آرایه نیست
  if (!Array.isArray(ratings)) {
    console.error('⚠️ Ratings is not an array:', ratings);
    return (
        ...
        {stats && (
            <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
              <Col xs={24} sm={12} md={6}>
                <Card style={{ borderRadius: 12, borderColor: '#e8e8f0' }}>
                  <Statistic
          ...
          {selectedRating && (
              <div>
                ...
                <div style={{ marginBottom: 16 }}>
                  <Rate disabled defaultValue={selectedRating.score} allowHalf count={5} />
                </div>
          ...
          {selectedRating && (
              <div>
                ...
                <Form form={replyForm} onFinish={handleReplySubmit} layout="vertical">
                  ...
                  >
                    <TextArea rows={4} placeholder={t('reply_placeholder', 'متن پاسخ...')} />
                  </Form.Item>
