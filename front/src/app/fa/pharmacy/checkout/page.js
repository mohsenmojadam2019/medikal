...
export default function PharmacyCheckoutPage() {
    ...
    useEffect(() => {
        ...
        if (cartData.length === 0) {
            ...
            setTimeout(() => router.push('/fa/pharmacy'), 1500);
        }
    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                router.push('/fa/profile/pharmacy-orders');
            }, 1500);
        } catch (error) {
    ...
    const handleGatewayPayment = async () => {
        ...
        try {
            ...
            localStorage.setItem('pendingOrder', JSON.stringify({
                ...
                returnUrl: '/fa/profile/pharmacy-orders',
            }));
        ...
        return (
            <>
                ...
                <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', textAlign: 'center' }}>
                    ...
                    <Button type="primary" onClick={() => router.push('/fa/pharmacy')}>
                        ادامه خرید
                    </Button>
                </div>
                <Footer />
