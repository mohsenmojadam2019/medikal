...
@section('page_title', '➕ ایجاد نقش جدید')
@section('page_description', 'ایجاد نقش جدید در سیستم')
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror"
                       id="name" name="name" value="{{ old('name') }}" placeholder="مثلاً: editor" required>
                @error('name')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <small style="color:#94a3b8;font-size:0.75rem;">نام نقش باید به انگلیسی و بدون فاصله باشد.</small>
            </div>
